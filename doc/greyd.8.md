...
* The current implementation is a port to Go of the original C code base, keeping the same configuration files, wire protocols and command line switches.
